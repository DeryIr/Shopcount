...
<body>
    ...
    <header>
        ...
        <div class="text-center bg-image"
            style="
            background-image: url('img/Halsupercell.png');
            height: 400px;
            margin-top: 67px;
            margin-bottom: 20px;
          ">
    ...
    <main>
        <div class="container">
            <!-- Products -->
            <div class="row">
                @foreach ($data as $produksupercell)
                    <div class="col-lg-3 col-md-6 mb-4">
                        <section>
                            <div class="card">
                                <div class="bg-image hover-zoom ripple ripple-surface ripple-surface-light"
                                    data-mdb-ripple-color="light">
                                    <img src="{{ asset('img/store/' . $produksupercell->gambar) }}" class="w-100" />
                                    <a href="{{ route('user.pesan', $produksupercell->id) }}">
